    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDoiMatkhau.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CompanyDetailsActivity.this, ChangePasswordActivity.class);
        ...
        btnInternConnect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CompanyDetailsActivity.this, AboutUsActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnChinhSach.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CompanyDetailsActivity.this, SecurityActivity.class);
                startActivity(intent);
            }
        });
    }
